...
class Command(BaseCommand):
    ...
    def load_partners(self):
        ...
        partners_data = [
            ...
            {
                'name': 'ANOFM',
                'logo_file': 'ANOFM.webp',
                'description': 'Agentia Nationala pentru Ocuparea Fortei de Munca',
                'partner_type': 'internal',
                'order': 9,
            },
            {
                'name': 'ASEM',
                'logo_file': 'ASEM.webp',
                'description': 'Academia de Studii Economice din Moldova',
                'partner_type': 'internal',
                'order': 10,
            },
            {
                'name': 'RDA Odesa',
                'logo_file': 'RDA_Odesa.webp',
                'description': 'Agentia de Dezvoltare Regionala Odesa',
                'partner_type': 'international',
                'order': 11,
            },
            {
                'name': 'Digital Innovation Zone',
                'logo_file': 'DigitalInnovation.webp',
                'description': 'Zona de inovare digitala',
                'partner_type': 'internal',
                'order': 12,
            },
            {
                'name': 'Hygia',
                'logo_file': 'Hygia.webp',
                'description': 'Partener in domeniul sanatatii si inovatiei',
                'partner_type': 'internal',
                'order': 13,
            },
            {
                'name': 'Technovator',
                'logo_file': 'Technovator.webp',
                'description': 'Platforma de inovare tehnologica',
                'partner_type': 'internal',
                'order': 14,
            },
            {
                'name': 'UNICEF',
                'logo_file': 'UNICEF.webp',
                'description': 'Fondul Natiunilor Unite pentru Copii',
                'partner_type': 'international',
                'order': 15,
            },
            {
            ...
            },
            {
                'name': 'UTM',
                'logo_file': 'UTM.webp',
                'description': 'Universitatea Tehnica a Moldovei',
                'partner_type': 'internal',
                'order': 17,
            },
        ]
    ...
    def load_statistics(self):
        ...
        stats_data = [
            ...
            {
                'key': 'ima_residents',
                'value': '9 companii (13 angajați)',
                'suffix': '',
                'decimal_places': 0,
                'label': 'Rezidenți activi',
                'icon_class': 'fas fa-building',
                'category': 'ima',
                'order': 2,
            },
            ...
            # --- Partners stats (from parteneri.html) ---
            {
                ...
                'suffix': '',
                'decimal_places': 0,
                'label': 'Parteneri din 6 țări europene',
                'icon_class': 'fas fa-globe',
                'category': 'partners',
                'order': 1,
            },
            {
                'key': 'partners_projects_submitted',
                'value': '17',
                'suffix': '',
                'decimal_places': 0,
                'label': 'Proiecte depuse spre finanțare',
            ...
            {
                'key': 'partners_budget',
                'value': 'cca. 22 mln Euro',
                'suffix': '',
                'decimal_places': 0,
                'label': 'Buget proiecte depuse',
